          ...
          <div className="max-w-md w-full space-y-8 sm:space-y-10">
            ...
            <div className="flex flex-col items-center md:items-start gap-4">
              <Link
                ...
                className="inline-flex items-center justify-center bg-[#5B8C3A] hover:bg-[#4A722F] text-white font-display font-bold text-xl sm:text-2xl px-10 py-5 rounded-2xl transition-all shadow-xl hover:scale-105 active:scale-95 w-full sm:w-auto focus-ring"
              >
                Start a Poll
              </Link>
              <Link
